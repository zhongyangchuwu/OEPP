...
from oepp.api import run as run_api
from oepp.api.run import _validate_manifest
...
class RunBudgetTests(unittest.TestCase):
    def test_new_run_does_not_consume_another_runs_budget(self) -> None:
        with tempfile.TemporaryDirectory() as directory:
            ...
            with (
                patch.object(run_api, "API_RUNS_ROOT", root / "runs"),
                patch.object(run_api, "REPOSITORY_ROOT", root),
